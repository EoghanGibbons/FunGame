...
*/
ProjBel.AnimationComponent = function (actor) {
    'use strict';
...
/**  
    ...
    * @param {ProjBel.Entity} actor - Reference to the Entity that this component belongs to 
*/
ProjBel.AnimationComponent.prototype.initialize = function (actor) {
    'use strict';
...
/**  
    ...
    * @param {ProjBel.Entity} actor - Reference to the Entity that this component belongs to 
*/
ProjBel.AnimationComponent.prototype.update = function (actor) {
    'use strict';
