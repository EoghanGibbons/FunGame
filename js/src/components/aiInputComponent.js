...
*/
ProjBel.AiInputComponent = function (actor) {
    'use strict';
...
/**  
    ...
    * @param {ProjBel.Entity} actor - Reference to the Entity that this component belongs to 
*/
ProjBel.AiInputComponent.prototype.update = function (actor, game) {
    'use strict';
...
ProjBel.AiInputComponent.prototype.addPathfinding = function (pathfinding) {
    'use strict';
    this.pathfinding = pathfinding;
};

ProjBel.AiInputComponent.prototype.reached_target_position = function (actor_position, target_position) {
    "use strict";
    var distance;
...
ProjBel.AiInputComponent.prototype.move = function (start_pos, target_position) {
    "use strict";
    this.pathfinding.find_path(start_pos, target_position, this.move_through_path, this);
};
 
ProjBel.AiInputComponent.prototype.move_through_path = function (path) {
    "use strict";
    if (path !== null) {
        this.path = path;
        this.path_step = 0;
